                    ...
                    <div class="col-md-4">
                        ...
                        <div class="group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('t_pilih_buku?id='.$id); ?>" class="btn btn-default" style="margin-top: 10px; margin-bottom: 10px">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <table class="table table-bordered" style="margin-bottom: 10px">
            ...
            <td style="text-align:center" width="200px">
                <form action="<?php echo site_url('t_pilih_buku/createAction'); ?>" method="post">
                <input type="hidden" name="id_buku" value="<?php echo $t_buku->id_buku; ?>" /> 
                <input type="hidden" name="id_anggota" value="<?php echo $id; ?>" />
                <input type="hidden" name="tanggal_pinjam" value="<?php echo date("Y/m/d"); ?>" /> 
                <input type="submit" class="btn btn-primary" onclick="return confirm('Are you sure?')" value="Pilih" />                
                </form>
            </td>
        </tr>
                <?php
