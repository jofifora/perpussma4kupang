        ...
        <div class="main-login main-center">
          <form class="form-horizontal" method="post" action="">
            ...
            <div class="form-group">
              <label for="username" class="cols-sm-2 control-label">No. Anggota <?php echo form_error('username') ?></label>
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
                  <input type="text" class="form-control" name="username" id="username"  placeholder="Masukan No. Anggota Anda" required data-validation-required-message="Username Belum Diisi."/>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="password" class="form-control" name="password" id="password"  placeholder="Masukan Password Anda" required data-validation-required-message="Password Belum Diisi."/>
                </div>
              </div>
            </div>
